...
import { MultiTranche, IcToken, ERC20Mintable } from '../../../typechain-types';
...
const { ethers } = hre;
/**
 * Compound Borrowing Agreement Template contract tests
 */
describe.only('Compound Borrowing', () => {
  ...
  it('hex4Bytes', async () => {
    console.log(hex4Bytes('THIS_CONTRACT'));
  });
