...
import { addSteps, businessCaseTest, getTimestampInSec } from '../utils/utils';
...
const parentSuite = describe.only('Agreement: business case', () => {
...
const NEXT_MONTH = NOW + ONE_MONTH;
const NEXT_TWO_MONTH = NOW + 2 * ONE_MONTH;
const tests = {
  'Lifecycle Test Multiple LPs': [
    {
      ...
      HURDLE: 9,
      PROFIT_PART: 20,
      PLACEMENT_DATE: NEXT_MONTH,
      CLOSING_DATE: NEXT_TWO_MONTH,
