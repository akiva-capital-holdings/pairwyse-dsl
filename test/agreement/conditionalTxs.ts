...
//     const { txId } = txs[0];
//     app.addTxBlueprint(txId, txs[0].requiredTxs, txs[0].signatory);
//     app.addTxCondition(txId, txs[0].conditionStr, txs[0].conditionCtx.address);
//     app.addTxTransaction(txId, txs[0].transactionStr, txs[0].transactionCtx.address);
...
//     for (let i = 0; i < condCtxLen; i++) {
//       await parser.parse(await app.conditionCtxs(txId, i), await app.conditionStrs(txId, i));
//     }
...
//   it.only('test two transactions', async () => {
...
//     app.addTxBlueprint(txId0, txs[0].requiredTxs, txs[0].signatory);
//     app.addTxCondition(txId0, txs[0].conditionStr, txs[0].conditionCtx.address);
//     app.addTxTransaction(txId0, txs[0].transactionStr, txs[0].transactionCtx.address);

//     // Set conditional transaction
//     const { txId: txId1 } = txs[1];
//     app.addTxBlueprint(txId1, txs[1].requiredTxs, txs[1].signatory);
//     app.addTxCondition(txId1, txs[1].conditionStr, txs[1].conditionCtx.address);
//     app.addTxTransaction(txId1, txs[1].transactionStr, txs[1].transactionCtx.address);
...
//     const condCtxLen1 = (await app.conditionCtxsLen(txId0)).toNumber();
