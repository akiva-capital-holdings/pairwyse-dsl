...
/**
 * Voting implementation in the Governance contract that is based of a
...
contract Governance is Agreement {
    ...
    /**
     * Sets parser address, creates new Context instance
     */
    constructor(
        address _parser,
        address _ownerAddr,
    ...
    function _setParameters(
        ...
        _update(_recordId, _requiredRecords, _signatories, _record, _conditionStrings);
